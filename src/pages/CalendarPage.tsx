          ...
          <div className="grid grid-cols-[60px_repeat(5,1fr)]">
            ...
            <div className="border-r border-border/80">
              {timeSlots.map((hour, idx) => (
                <div
                  key={hour}
                  className="h-[60px] relative border-b border-border/80"
                >
                  {idx > 0 && (
              ...
              return (
                ...
                >
                  ...
                  {timeSlots.map((hour) => (
                    <div
                      key={hour}
                      className="h-[60px] border-b border-border/80"
                    />
                  ))}
                        ...
                        >
                          ...
                          >
                            <Button
                              ...
                              size="icon"
                              variant="secondary"
                              className="absolute right-1 top-1 h-5 w-5 rounded-full border border-white/20 bg-black/35 text-white hover:bg-black/55 opacity-100 sm:opacity-0 sm:group-hover:opacity-100"
                              onClick={(e) => {
                                e.stopPropagation();
