    ...
    <header className="sticky top-0 z-40 border-b border-sidebar-border/80 bg-sidebar/85 backdrop-blur-xl">
      <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-4 sm:px-6">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-primary/55 bg-primary/25 shadow-[0_0_28px_hsl(var(--primary)/0.35)]">
            <TridentIcon className="h-5 w-5 text-cyan-100 [stroke-width:2.6] drop-shadow-[0_0_6px_hsl(var(--primary)/0.6)]" />
          </div>
